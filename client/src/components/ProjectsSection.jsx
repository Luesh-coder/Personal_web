...
// Stagger delays matched to card index
const staggerClass = ["", "reveal-delay-2", "reveal-delay-4"];
    ...
    return (
        <section id="projects" className="py-28 px-2 md:px-10 relative">
            <div className="container mx-auto max-w-[90vw]">
                <h2
                    ref={headingRef}
                    className="scroll-reveal text-4xl md:text-6xl font-bold mb-6 text-center"
                >
                ...
                <p
                    ref={subtitleRef}
                    className="scroll-reveal reveal-delay-2 text-center text-2xl text-muted-foreground mb-14 max-w-3xl mx-auto"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {projects.map((project, i) => (
                        <div
                            key={project.id}
                            ref={cardRefs[i]}
                            className={`scroll-reveal ${staggerClass[i]} group bg-card rounded-xl overflow-hidden shadow-md card-hover text-lg flex flex-col`}
                        >
                ...
                <div ref={ctaRef} className="scroll-reveal text-center mt-12">
                    <a
